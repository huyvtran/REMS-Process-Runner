 ...
 */
public class GnrtSchldRnsfunc extends Thread {

    private Thread t;
    private String threadName;

    GnrtSchldRnsfunc(String name) {
        threadName = name;
        ...
        try {
            do {
                ...
                for (int i = 0; i < ttlRws; i++) {
                    ...
                    long schdlID = Long.parseLong(dtst.getString(1));
                    ...
                    if (Global.doesLstRnTmExcdIntvl(rpt_id,
                        ...
                        String prmIDs = "";
                        String prmVals = "";
                        ResultSet dtstPrm = Global.get_SchdulesParams(schdlID);
                        dtstPrm.last();
